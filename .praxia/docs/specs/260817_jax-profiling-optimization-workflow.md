...
- **Task 12 (2026-08-20):** SLURM **20832764** COMPLETED 00:26:20 on node3200 (H200, `mit_preemptable`). `verdict=PASS`, `n_pairs=21`, `median_delta=8.07e-4`, 90% CI `[-0.00209, 0.00383]` within ±0.05. P5 equivalence holds at Stage-2 size for (1vii, flash, PME-on, 1.0 Å). `PROLIX_GIT_SHA=83cc282`. P8 report + fixtures committed the same day; remaining #4325 hold is STEP/SIDECAR/`TERM_RANKING`/`trace.py` GPU legs, not P8.
...
**Step notes (2026-08-20):** `scripts/profiling/report.py` + `tests/profiling/test_report.py` + `tests/profiling/fixtures/records/*.json` landed. Fixtures written via `ProbeRecord.write`. No prolix imports in `scripts/profiling/`.
