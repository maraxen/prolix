...
def animate_trajectory(
  ...
  if len(positions) == 0:
    msg = "No frames found or stride too large."
  ...
  n_frames, _n_atoms, _ = positions.shape
  ...
  scat = ax.scatter(
    positions[0, :, 0], positions[0, :, 1], positions[0, :, 2], c="blue", alpha=0.6, s=10
  )
  ...
  txt = fig.text(0.1, 0.9, "Time: 0.00 ns", transform=fig.transFigure)
