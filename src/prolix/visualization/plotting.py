...
def plot_contact_map(
    ...
    im = ax.imshow(cmap, origin='lower', cmap='Greys')
...
def plot_ramachandran(
    ...
    # analysis.compute_dihedrals handles (..., N, 3)
    # returns (..., M)
    ...
    ax.hist2d(phi_deg, psi_deg, bins=60, range=[[-180, 180], [-180, 180]], cmap='viridis', density=True)
