...
def compute_radius_of_gyration(positions: Array, masses: Optional[Array] = None) -> Array:
...
def compute_fraction_native_contacts(
    ...
    current_map = compute_contact_map(positions, threshold_angstrom * 1.2, mask) # Often slightly looser
