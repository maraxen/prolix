"""Virtual Site reconstruction logic."""
...
def reconstruct_virtual_sites(
    ...
    vs_def: jnp.ndarray, # (N_vs, 4) [vs_idx, p1, p2, p3]
    vs_params: jnp.ndarray # (N_vs, 12)
) -> jnp.ndarray:
    ...
    def body_fn(i, current_pos):
        ...
        current_pos = current_pos.at[idx].set(new_r)
        return current_pos
    ...
    # Scatter update
    vs_indices = vs_def[:, 0]
    updated_positions = positions.at[vs_indices].set(new_vs_pos)
