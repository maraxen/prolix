...
class TestEnergyParity:
    """Per-term bonded energy parity between OpenMM and prolix."""

    @pytest.fixture
    def parity_bundle(self, ala_dip_reference):
    ...
    def test_bond_energy_parity(self, parity_bundle):
    ...
    def test_angle_energy_parity(self, parity_bundle):
    ...
    def test_dihedral_energy_parity(self, parity_bundle):
...
class TestForceParity:
    """Per-atom force parity between OpenMM and prolix."""

    def test_force_parity(self, ala_dip_reference):
...
class TestFieldAudit:
    """Smoke test for field-audit module."""

    def test_field_audit_smoke(self, ala_dip_reference):
