...
def _langevin_step_o_constrained(
    ...
    # Write constrained momenta back
    # (implementation detail: scatter operation to place 3×3 blocks back into full (N,3) array)
    # p_out = scatter_water_momenta(p_ou_full, p_water_new, water_indices)
...
## 5. Expected Outcome for Phase 2 Implementation
